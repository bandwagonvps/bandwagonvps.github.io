...
const targetTable2 = `<div class="overflow-x-auto my-6 bg-white rounded-xl shadow-sm ring-1 ring-slate-200">
<table class="w-full text-sm text-left table-auto">
<thead class="bg-slate-50/50 text-slate-500 font-medium border-b border-slate-100">
<tr>
...
} else if (code.includes(targetTable2)) {
  code = code.replace(targetTable2, replacementHTML.trim());
  fs.writeFileSync(file, code, 'utf8');
  console.log('Replaced table 2 successfully.');
} else {
