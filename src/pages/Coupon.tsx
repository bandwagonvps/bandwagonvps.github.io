...
<details class="group bg-white rounded-xl shadow-sm ring-1 ring-slate-200 my-4 overflow-hidden">
  <summary class="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span class="pr-6 font-medium">1. 搬瓦工优惠码可以叠加使用吗？</span>
...
<details class="group bg-white rounded-xl shadow-sm ring-1 ring-slate-200 my-4 overflow-hidden">
  <summary class="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span class="pr-6 font-medium">2. 搬瓦工优惠码可以用于续费吗？</span>
    <span class="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
<details class="group bg-white rounded-xl shadow-sm ring-1 ring-slate-200 my-4 overflow-hidden">
  <summary class="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span class="pr-6 font-medium">3. 为什么别人能用，我这里用不了？</span>
    <span class="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
<details class="group bg-white rounded-xl shadow-sm ring-1 ring-slate-200 my-4 overflow-hidden">
  <summary class="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span class="pr-6 font-medium">4. 优惠码失效了，还值得买搬瓦工吗？</span>
    <span class="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
<details class="group bg-white rounded-xl shadow-sm ring-1 ring-slate-200 my-4 overflow-hidden">
  <summary class="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span class="pr-6 font-medium">5. 买完后还能补用优惠码吗？</span>
    <span class="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
<details class="group bg-white rounded-xl shadow-sm ring-1 ring-slate-200 my-4 overflow-hidden">
  <summary class="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span class="pr-6 font-medium">6. 搬瓦工优惠码是永久折扣吗？</span>
    <span class="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
