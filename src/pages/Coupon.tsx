...
import { List, User, BookOpen } from 'lucide-react';
import { useSEO } from '../lib/useSEO';
import { chooseArticles } from '../data/articles';
...
<details className="group bg-white rounded-xl shadow-sm ring-1 ring-slate-200 my-4 overflow-hidden">
  <summary className="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span className="pr-6 font-medium">1. 搬瓦工优惠码可以叠加使用吗？</span>
    <span className="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
<details className="group bg-white rounded-xl shadow-sm ring-1 ring-slate-200 my-4 overflow-hidden">
  <summary className="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span className="pr-6 font-medium">2. 搬瓦工优惠码可以用于续费吗？</span>
    <span className="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
<details className="group bg-white rounded-xl shadow-sm ring-1 ring-slate-200 my-4 overflow-hidden">
  <summary className="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span className="pr-6 font-medium">3. 为什么别人能用，我这里用不了？</span>
    <span className="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
<details className="group bg-white rounded-xl shadow-sm ring-1 ring-slate-200 my-4 overflow-hidden">
  <summary className="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span className="pr-6 font-medium">4. 优惠码失效了，还值得买搬瓦工吗？</span>
    <span className="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
<details className="group bg-white rounded-xl shadow-sm ring-1 ring-slate-200 my-4 overflow-hidden">
  <summary className="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span className="pr-6 font-medium">5. 买完后还能补用优惠码吗？</span>
    <span className="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
<details className="group bg-white rounded-xl shadow-sm ring-1 ring-slate-200 my-4 overflow-hidden">
  <summary className="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span className="pr-6 font-medium">6. 搬瓦工优惠码是永久折扣吗？</span>
    <span className="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-3/4">
            ...
            <div className="bg-white p-8 sm:p-10 rounded-3xl shadow-sm ring-1 ring-slate-200 mt-12 flex flex-col sm:flex-row gap-6 items-start sm:items-center">
              <div className="shrink-0 flex items-center justify-center w-16 h-16 rounded-full bg-amber-50 ring-amber-500/20 ring-1 font-bold text-amber-600 text-2xl">
