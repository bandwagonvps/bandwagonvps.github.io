...
export const startArticles: Article[] = [
  {
    ...
    content: `
# 新手搬瓦工教程：注册购买、KiwiVM 后台和 SSH 连接完整流程
...
看到这里，你大概知道搬瓦工是什么了。下一步别急着付款。

还没定用途，先看“搬瓦工适合新手吗”和“搬瓦工适合建站吗”；已经决定买，再看“搬瓦工新手买哪个套餐”“搬瓦工机房怎么选”和“搬瓦工优惠码怎么用”；要是已经买完了，优先学“搬瓦工 KiwiVM 面板教程”“搬瓦工 SSH 登录教程”“搬瓦工重装系统教程”和“搬瓦工搭建 WordPress 教程”。
...
第一个要看的就是时间。搬瓦工退款更适合 30 天内的新订单。已经用了几个月，或者到期后续费了又后悔，就别再按新订单那套去理解。
...
搬瓦工退款不是长期免费试用的机制。普通用户买错一次、测完不合适，可以理解。但同一个用户、关联账号、相同的付款信息反复买了又退，后面就别指望每次都能顺利过了。
...
搬瓦工退款不能简单理解成“只取消当前这台 VPS”。申请前要确认账户下其他服务会不会受到影响。
