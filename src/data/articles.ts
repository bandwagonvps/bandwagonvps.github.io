...
export const chooseArticles: Article[] = [
  {
    slug: 'banwagong-isp-network-selection-2026',
    category: 'choose',
    title: '搬瓦工电信、联通、移动用户怎么选机房？2026 三网线路与套餐推荐',
    meta: '搬瓦工机房不能只看哪里离中国近。电信、联通、移动走的线路不同，本文详细教你电信、联通、移动用户如何避免踩坑，选择最合适的搬瓦工机房与套餐。',
    date: '2026-06-17',
    toc: [
      { id: 'section-1', title: '电信、联通、移动用户怎么选搬瓦工机房？' },
      { id: 'section-2', title: '为什么同一个搬瓦工机房，不同运营商速度差很多？' },
      { id: 'section-3', title: '选机房之前，先确认你的使用场景' },
      { id: 'section-4', title: '电信用户怎么选搬瓦工机房？' },
      { id: 'section-5', title: '联通用户怎么选搬瓦工机房？' },
      { id: 'section-6', title: '移动用户怎么选搬瓦工机房？' },
      { id: 'section-7', title: '三网访客都有，怎么选？' },
      { id: 'section-8', title: '搬瓦工电信、联通、移动用户更适合买哪个套餐？' },
      { id: 'section-9', title: '别把搬瓦工优惠码当成核心决策' },
      { id: 'section-10', title: '买完后怎么选 Location？按这个顺序测试' },
      { id: 'section-11', title: '搬瓦工三网选机房常见问题' },
      { id: 'section-12', title: '最终选择建议' }
    ],
    content: `
# 搬瓦工电信、联通、移动用户怎么选机房？2026 三网线路与套餐推荐

搬瓦工机房不能只看哪里离中国近。电信、联通、移动走的线路不同，同一个 VPS，电信打开顺，移动未必顺；白天测试能用，晚高峰后台保存文章、上传图片、打开插件页面，体验可能完全变样。

电信用户优先看 DC6 CN2 GIA-E 和 DC9 CN2 GIA，预算高再看香港、东京、大阪 CN2 GIA。联通用户先测日本大阪软银 JPOS_1，再测荷兰 EUNL_9；如果网站面向三网访客，把 DC6 / DC9 放回基准位。移动用户有 HK85 / CMI 可以先看 HK85，没有库存就回到 CN2 GIA-E，先测 DC6 / DC9。

大多数中文站、WordPress 站、资料站和 Affiliate 站，第一台正式 VPS 先看 CN2 GIA-E。它的好处在于可测试空间大，价格也比高端香港、东京套餐更容易承受。

---

## <a id="section-1"></a>电信、联通、移动用户怎么选搬瓦工机房？

| 用户类型 | 首选机房                      | 备选机房                         | 推荐套餐方向                    | 适合场景               |
| ---- | ------------------------- | ---------------------------- | ------------------------- | ------------------ |
| 电信用户 | DC6 CN2 GIA-E、DC9 CN2 GIA | 香港 / 东京 / 大阪 CN2 GIA         | CN2 GIA-E、高端 CN2 GIA      | 中文站、WordPress、后台管理 |
| 联通用户 | JPOS_1 日本大阪软银、EUNL_9 荷兰联通 | DC6、DC9                      | CN2 GIA-E                 | 联通访客、自用、预算型建站      |
| 移动用户 | HK85 / CMI                | DC6、DC9、香港 / 东京 / 大阪 CN2 GIA | HK85、CN2 GIA-E、高端 CN2 GIA | 移动用户为主             |
| 三网混合 | DC6、DC9                   | 香港 / 东京 / 大阪 CN2 GIA         | CN2 GIA-E、高端 CN2 GIA      | 全国访客、中文内容站         |
| 学习测试 | 普通 KVM、DC3、DC8            | 其他低价机房                       | [KVM 入门款](https://bwh81.net/aff.php?aff=80471&pid=44)                   | 学 Linux、测试环境       |

这张表用于下单前筛选。先按运营商缩小范围，再看套餐能不能选目标 Location，最后用自己的网络测一次。

搬瓦工机房很多，真正和这篇主题强相关的就这几类：DC6、DC9、JPOS_1、EUNL_9、HK85，以及高端香港、东京、大阪 CN2 GIA。其余机房可以留到学习测试或特殊用途里再看。

## <a id="section-2"></a>为什么同一个搬瓦工机房，不同运营商速度差很多？

海外 VPS 到国内访问，中间看的不是直线距离。服务器在美国、日本、香港，只代表地理位置；真正影响体验的是线路、回程、国际出口、晚高峰拥堵，还有你本地运营商怎么走。

电信用户更吃 CN2 GIA / CN2 GIA-E。普通国际线路白天还能打开，晚上开始抖，后台保存文章、图片加载、页面响应都会受影响。

联通用户有另一套测试路线。JPOS_1 日本大阪软银、EUNL_9 荷兰联通都值得放进候选名单，尤其是自用或访客明显偏联通的项目。

移动用户看香港时先看线路名称。香港位置近，但真正影响移动体验的是 HK85 / CMI 这类线路方向。只看到“香港”两个字就下单，后面容易失望。

## <a id="section-3"></a>选机房之前，先确认你的使用场景

自己远程用 VPS，按自己的宽带运营商选。家里是电信，先测 DC6 / DC9；联通宽带，先测 JPOS_1；移动宽带，有 HK85 就先看 HK85。

建站给别人访问，按访客来源选。中文内容站、资料站、WordPress 站、Affiliate 站，通常三网访客都有，这时把综合稳定放在第一位。

学习 Linux、装宝塔、测试脚本，低价 KVM 能用。正式中文站把普通 KVM 留在备选区，主力先看 CN2 GIA-E 或高端 CN2 GIA。

## <a id="section-4"></a>电信用户怎么选搬瓦工机房？

电信用户推荐顺序：

1. [DC6 CN2 GIA-E 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=87)
2. [DC9 CN2 GIA 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=87)
3. [香港 CN2 GIA 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=95)
4. [东京 CN2 GIA 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=95)
5. [大阪 CN2 GIA 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=95)

电信用户买搬瓦工，重点不是选最近的机房，而是避开晚高峰容易波动的普通线路。DC6、DC9 放在前面，是因为它们在价格、线路和长期建站体验之间更平衡。

如果你做的是中文 WordPress 站，别只看首页能不能打开。后台保存文章、上传图片、打开媒体库、进入插件设置页，这些动作更接近真实使用。Ping 低，只说明网络响应快一点；后台卡，才会真正拖慢你更新网站的效率。

预算有限，先从 CN2 GIA-E 里的 DC6 / DC9 测起。这个组合对多数电信用户更稳，后期也有调整空间。

香港、东京、大阪 CN2 GIA 适合业务站、客户后台、会员系统，或者访问价值比较高的项目。它们的价值在低延迟和更好的访问体验，短板是价格高。只学 Linux、装宝塔、测试脚本，用不上这类套餐。

## <a id="section-5"></a>联通用户怎么选搬瓦工机房？

联通用户推荐顺序：

1. [JPOS_1 日本大阪软银 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=87)
2. [EUNL_9 荷兰联通 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=87)
3. [DC6 CN2 GIA-E 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=87)
4. [DC9 CN2 GIA 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=87)
5. [香港 / 东京 / 大阪 CN2 GIA 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=95)

联通用户有自己的选择路线。电信优先 DC6 / DC9 没问题，但联通直接照搬这个顺序，容易漏掉 JPOS_1 和 EUNL_9。

JPOS_1 日本大阪软银适合先测，尤其是自用、远程管理、轻量建站这类场景。联通访问日本软银，经常比普通美国机房更值得期待。

EUNL_9 荷兰联通适合访客明显偏联通的项目。它不是所有中文站的默认选择，但在联通场景里有测试价值。

做三网网站时，把 DC6 / DC9 拉回来对比。资料站、VPS affiliate 站、中文内容站通常面向全国访客，只照顾联通单网，电信和移动体验可能被拉低。先测 JPOS_1，再测 EUNL_9，最后用 DC6 / DC9 做综合基准，这个顺序更稳。

## <a id="section-6"></a>移动用户怎么选搬瓦工机房？

移动用户推荐顺序：

1. [HK85 / CMI 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=121)
2. [DC6 CN2 GIA-E 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=87)
3. [DC9 CN2 GIA 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=87)
4. [香港 CN2 GIA 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=95)
5. [东京 / 大阪 CN2 GIA 套餐入口](https://bwh81.net/aff.php?aff=80471&pid=95)

移动用户选搬瓦工，先看线路，再看机房城市。香港听起来近，但香港机房不等于移动访问一定好。HK85 / CMI 才是移动用户更该关注的方向。

如果 HK85 有库存，而且你的访问来源确实以移动为主，可以优先看。这里要多看一眼套餐规则：限量、库存、迁移限制，这些都会影响后期调整空间。买之前确认清楚，后面少折腾。

买不到 HK85，回到 CN2 GIA-E。先测 DC6 / DC9，比一直等限量套餐更实际。网站要上线，内容要发布，项目节奏比单个稀缺套餐更重要。

高预算项目可以看香港、东京、大阪 CN2 GIA。预算有限，先把 CN2 GIA-E 用好。移动本身对线路敏感，正式站更需要把普通 KVM 放到学习测试场景里。

## <a id="section-7"></a>三网访客都有，怎么选？

中文网站最常见的情况是三网访客都有。全国用户打开你的页面，不会只来自电信或联通。

这种场景下，单一运营商的最低延迟价值有限。联通测得好看，电信未必稳；移动打开顺，三网综合体验也未必最好。三网混合站点更该看稳定和均衡。

预算有限，选 CN2 GIA-E，先测 DC6 / DC9。预算充足，再看香港、东京、大阪 CN2 GIA。访客来源还没跑出来之前，优先买可测试空间更大的套餐，给后期留调整余地。

## <a id="section-8"></a>搬瓦工电信、联通、移动用户更适合买哪个套餐？

### 多数人首选：CN2 GIA-E 套餐

多数中文站先看 CN2 GIA-E。它适合电信、联通、移动混合访问的站点，也适合 WordPress、资料站、工具站、Affiliate 站。

它的核心价值是可测试空间大。电信可以测 DC6 / DC9，联通可以加测 JPOS_1 / EUNL_9，移动买不到 HK85 时也能回到 DC6 / DC9。

和高端香港、东京套餐相比，CN2 GIA-E 更容易承受。第一台正式中文站 VPS，先把线路、后台、访问速度跑稳，比一开始追高价套餐更实际。

<div class="not-prose my-6"><a href="https://bwh81.net/cart.php?a=add&pid=87&aff=80471" target="_blank" rel="nofollow noopener noreferrer" class="inline-flex items-center justify-center rounded-lg bg-amber-500 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-amber-600 transition-all">查看 CN2 GIA-E 套餐</a></div>

下单前核对当前套餐可选 Location。买完进入 KiwiVM 后台，再按自己的运营商测试机房。

### 高预算项目：香港 / 东京 / 大阪 CN2 GIA

香港、东京、大阪 CN2 GIA 适合企业站、业务站、高价值中文流量，尤其是客户后台、会员系统、在线业务页面这类对速度和稳定性更敏感的项目。

这类套餐价格高，适合长期项目。学习 Linux、装宝塔、跑测试脚本，把预算留给内容、工具和后期续费更划算。

<div class="not-prose my-6"><a href="https://bwh81.net/cart.php?a=add&pid=95&aff=80471" target="_blank" rel="nofollow noopener noreferrer" class="inline-flex items-center justify-center rounded-lg bg-amber-500 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-amber-600 transition-all">查看高端 CN2 GIA 套餐</a></div>

### 移动用户重点看：HK85 / CMI

主要访问来源是移动用户，可以优先关注 HK85 / CMI。有库存时值得看，没有库存就回到 CN2 GIA-E 或高端 CN2 GIA。

HK85 更适合移动优先场景，但限量套餐要看迁移规则。买之前先确认你的用户是否真的以移动为主，别只因为自己当前用移动宽带就把整个站点押到一个限量套餐上。

<div class="not-prose my-6"><a href="https://bwh81.net/cart.php?a=add&pid=121&aff=80471" target="_blank" rel="nofollow noopener noreferrer" class="inline-flex items-center justify-center rounded-lg bg-amber-500 px-5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-amber-600 transition-all">查看 HK85 / 香港线路套餐</a></div>

## <a id="section-9"></a>别把搬瓦工优惠码当成核心决策

搬瓦工优惠码信息一直很乱。有些页面挂着“最新优惠码”，到结算页未必生效。购买决策放在几美元折扣上，容易把真正重要的机房和套餐放偏。

对电信、联通、移动用户来说，真正影响体验和成本的是线路适配。电信选错普通线路，联通漏测 JPOS_1，移动买了非 CMI 香港，后面花掉的时间和迁移成本，往往高过优惠码省下来的钱。

下单前先确认套餐能不能选目标 Location，再看价格是否能接受。优惠码有就算加分，没有也别影响机房选择。

## <a id="section-10"></a>买完后怎么选 Location？按这个顺序测试

电信用户先测 DC6。不理想，再测 DC9。预算足够、套餐支持时，再看香港、东京、大阪 CN2 GIA。电信用户一定要安排一次晚高峰测试，白天顺不代表晚上稳。

联通用户先测 JPOS_1，再测 EUNL_9。如果网站面向三网访客，把 DC6 / DC9 拉进来对比。一次测速只能当参考，长期机房要看连续几天的使用体验。

移动用户有 HK85，先看 HK85。没有 HK85，先测 DC6 / DC9。高预算项目再看香港、东京、大阪 CN2 GIA。限量套餐下单前先确认迁移规则。

测试时把 Ping 放到辅助位置。白天测一次，晚高峰测一次；看延迟，也看丢包和下载速度。建站用户还要看后台保存文章、上传图片、打开插件页面、首页首屏速度。真实业务打开速度，比测速截图更有意义。

### 核心机房测试 IP

下面这些测试 IP 只用于下单前后做线路参考。发布前再复核一次，最终以当前套餐可选 Location 和 KiwiVM 后台显示为准。

| 机房            | 适合人群    | 测试 IP           |
| ------------- | ------- | --------------- |
| DC6 CN2 GIA-E | 电信、三网混合 | 162.244.241.102 |
| DC9 CN2 GIA   | 电信、三网混合 | 65.49.131.102   |
| JPOS_1 日本大阪软银 | 联通优先    | 185.212.59.222  |
| EUNL_9 荷兰联通   | 联通优先    | 104.255.68.50   |
| HK85 / CMI    | 移动优先    | 45.78.20.216    |

测试时别只看 Ping。白天测一次，晚高峰再测一次；看延迟，也看丢包、下载速度和路由变化。建站用户还要打开自己的后台，测试保存文章、上传图片、打开首页和插件页面。这个结果比单张测速图更接近真实使用。

## <a id="section-11"></a>搬瓦工三网选机房常见问题

<details class="group my-4 overflow-hidden">
  <summary class="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span class="pr-6 font-medium">1. 电信用户一定要选 CN2 GIA 吗？</span>
    <span class="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
正式中文站优先看 CN2 GIA / CN2 GIA-E。预算有限时，DC6 / DC9 比直接上高端香港、东京更容易承受。学习测试可以用低价 KVM，正式站把它放到备选区。
...
<details class="group my-4 overflow-hidden">
  <summary class="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span class="pr-6 font-medium">2. 联通用户是不是一定选日本软银？</span>
    <span class="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
联通用户可以优先测试 JPOS_1，但自用和建站要分开判断。如果网站面向三网访客，DC6 / DC9 更适合做综合基准。
...
<details class="group my-4 overflow-hidden">
  <summary class="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span class="pr-6 font-medium">3. 移动用户买不到 HK85 怎么办？</span>
    <span class="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
回到 CN2 GIA-E，先测试 DC6 / DC9。预算高时，再看香港、东京、大阪 CN2 GIA。项目上线节奏比等待一个限量套餐更重要。
...
<details class="group my-4 overflow-hidden">
  <summary class="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span class="pr-6 font-medium">4. 三网访客都有，到底选 DC6 还是 DC9？</span>
    <span class="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
先测 DC6，再测 DC9。不同地区、不同运营商结果会有差异。正式站把晚高峰和真实网站打开速度放在前面，一次 Ping 只能当辅助参考。
...
<details class="group my-4 overflow-hidden">
  <summary class="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span class="pr-6 font-medium">5. 搬瓦工怎么换机房？买完速度不好可以切换机房吗？</span>
    <span class="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
部分套餐支持在 KiwiVM 后台切换机房，也就是很多人说的搬瓦工换机房或切换 Location。操作前先备份网站文件和数据库，再看当前套餐是否支持 Migrate。迁移后 IP、线路、延迟都可能变化，正式站尽量放在低流量时段操作。
...
<details class="group my-4 overflow-hidden">
  <summary class="cursor-pointer list-none flex items-center justify-between p-5 font-semibold text-slate-900 hover:bg-slate-50 transition-colors">
    <span class="pr-6 font-medium">6. IP 被墙了能免费换吗？</span>
    <span class="transition-transform group-open:rotate-180 flex-shrink-0 text-slate-400">
      <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path></svg>
    </span>
  </summary>
...
先看套餐规则和后台政策。IP 问题和机房问题分开处理，能切换机房不代表 IP 风险自动消失。购买前把这个风险算进去，后期心态会稳很多。

  </div>
</details>

## <a id="section-12"></a>最终选择建议

电信建站，优先 CN2 GIA-E，先测试 DC6 / DC9。
联通优先，先测试 JPOS_1，再看 EUNL_9、DC6 / DC9。
移动优先，有 HK85 先看 HK85，没货就回到 CN2 GIA-E。

三网混合，预算有限选 CN2 GIA-E，预算充足再看高端 CN2 GIA。

学习测试，低价 KVM 就够。正式中文站别用练手套餐硬撑。

如果你还不确定自己该选哪个机房，先看 CN2 GIA-E。它更适合大多数电信、联通、移动混合访问的中文站，也方便后续在多个机房之间测试。

<div class="not-prose mt-8"><a href="https://bwh81.net/cart.php?a=add&pid=87&aff=80471" target="_blank" rel="nofollow noopener noreferrer" class="inline-flex w-full sm:w-auto items-center justify-center rounded-xl bg-amber-500 px-8 py-4 text-sm font-bold text-white shadow-sm hover:bg-amber-600 transition-all text-center">查看搬瓦工 CN2 GIA-E 套餐</a></div>
`
  },
  {
...
| 使用需求                | 推荐套餐          | 直接判断          |
| ------------------- | ------------- | ------------- |
| 学习 VPS、预算低          | [KVM 入门套餐](https://bwh81.net/aff.php?aff=80471&pid=44)      | 够练手，别拿它当正式站首选 |
| 新手第一次正式购买           | [CN2 GIA-E 20G](https://bwh81.net/aff.php?aff=80471&pid=87) | 大多数人先看这个      |
| 个人博客 / 轻量 WordPress | [CN2 GIA-E 20G](https://bwh81.net/aff.php?aff=80471&pid=87) | 单站够用，成本可控     |
| 长期 WordPress / 多站点  | [CN2 GIA-E 40G](https://bwh81.net/aff.php?aff=80471&pid=88) | 空间更宽，后期少迁移    |
| 高预算、低延迟需求           | [香港 CN2 GIA 40G](https://bwh81.net/aff.php?aff=80471&pid=95) / [东京 CN2 GIA 40G](https://bwh81.net/aff.php?aff=80471&pid=108) | 少数明确需求再买      |
...
* 学习 VPS：[KVM 入门套餐](https://bwh81.net/aff.php?aff=80471&pid=44)
* 新手正式建站：[CN2 GIA-E 20G](https://bwh81.net/aff.php?aff=80471&pid=87)
* 个人博客 / 轻量 WordPress：[CN2 GIA-E 20G](https://bwh81.net/aff.php?aff=80471&pid=87)
* 长期 WordPress / 多站点：[CN2 GIA-E 40G](https://bwh81.net/aff.php?aff=80471&pid=88)
* 高预算低延迟：[香港 CN2 GIA 40G](https://bwh81.net/aff.php?aff=80471&pid=95) / [东京 CN2 GIA 40G](https://bwh81.net/aff.php?aff=80471&pid=108)
...
export const troubleshootArticles: Article[] = [
  {
    slug: 'ssh-connection-failed-troubleshooting',
    category: 'troubleshoot',
    title: '搬瓦工 SSH 连不上？5分钟排查与修复指南',
    meta: '遇到 SSH 失联，第一反应绝不是盲目花钱换 IP。90% 的连接阻碍源于端口错位、机器假死或防火墙拦截。对照报错代码精准定位，将排查动作做对。',
    date: '2026-06-17',
    toc: [
      { id: 'section-1', title: '一、先看报错，一秒锁定死穴' },
      { id: 'section-2', title: '二、5 分钟无代码极速排查与修复清单' },
      { id: 'section-3', title: '三、确诊是 IP 被封？直接看 CN2 GIA-E' },
      { id: 'section-4', title: '四、常见问题 FAQ' }
    ],
    content: `
# 搬瓦工 SSH 连不上？5分钟排查与修复指南

遇到 SSH 失联，第一反应绝不是盲目花钱换 IP，更不需要重装系统。

90% 的连接阻碍并非因为“被墙”，而是源于端口错位、机器假死或防火墙拦截等基础配置失误。

放弃无意义的猜测。对照下方的报错代码精准定位，将排查动作做对。确认属于真正的 IP 死局后，再考虑更换方案。

## 一、先看报错，一秒锁定死穴

直接比对 SSH 客户端弹出的英文错误提示。不同的报错，对应的抢救方向截然不同。

| 报错代码 | 真实原因排查方向 | 优先动作 |
| :--- | :--- | :--- |
| **\`Connection timed out\`** | TCP 握手失败。源于端口被精准阻断、IP 被墙、或本地网络极差。 | 查网络连通性、测 SSH 端口 |
| **\`Connection refused\`** | 机器运行中，但目标端口无服务监听。 | 查机器是否开机、核实 5 位数端口 |
| **\`Permission denied\`** | 密码错，或用户名未使用全小写的 \`root\`。 | 核对全小写 root、一键重置密码 |
| **\`Host key verification failed\`** | 重装系统或换 IP 后的本地指纹冲突。 | 清理本地 \`known_hosts\` 旧记录 |

看到 \`Connection timed out\` 时，切忌直接与“IP 被封”划等号。务必继续向下排查，优先洗清端口和防火墙的嫌疑。

## 二、5 分钟无代码极速排查与修复清单

排查的第一步，应当从控制面板的基础数据入手，而非一头扎进复杂的 Linux 命令行。

### 1. 打破 Active 假象
官网 Client Area 显示的绿色 \`Active\` 仅代表账单已生效。必须进入 KiwiVM 控制面板，确认 Status 状态为绿色的 \`Running\`。
若未显示 Running，直接点击 Start。若页面卡死，果断 Force Stop 后再次开机。机器未启动，任何连接尝试都是徒劳。

### 2. 核实 3 个隐蔽参数
基础配置是最易翻车的环节。逐字核对 SSH 客户端的各项配置：
* **IP：** 严格以 KiwiVM 面板显示的 IP 为准。
* **端口 (Port)：** 搬瓦工默认分配随机 5 位数，**绝非 22**。
* **用户名：** 系统最高权限账户仅为全小写的 \`root\`，切勿填入 \`admin\` 或大写 \`Root\`。
* **密码：** 需输入系统 root 密码，而非搬瓦工官网账户密码。若遗忘，直接在左侧点击 \`Root password modification\` 重置。为找回密码而重装系统，是极高风险的无效操作。

### 3. 用 tcp.ping.pe 测端口（断症核心）
Ping 测试走的是 ICMP 协议，参考价值极其有限；SSH 走的是 TCP 协议。能 Ping 通仅代表机器存活，不代表 SSH 端口畅通。
打开测试工具，输入 \`服务器IP:SSH端口\`。直接通过测试图定性：
* **上半部分绿，下半部分国内全红：** 这是典型的“单端口 TCP 阻断”。IP 本身正常，进入 KiwiVM 的 Root Shell 强行将 SSH 更换至高位端口即可恢复。
* **上下两部分，国内节点一片惨红：** 这种情况属于毫无悬念的 IP 彻底封锁。
* **国内绿，仅个人网络受限：** 尝试切换手机热点。大概率是本地运营商或公司安全策略屏蔽了该端口。

### 4. 底层极限抢救（sshd 与防火墙）
若 IP 与端口测试全通，密码核对无误，却依然无法连接，通常是系统内部的 sshd 服务崩溃，或被修改失误的防火墙拦截。
进入 KiwiVM 的 \`Root Shell - interactive\`（这是无需网络的直连母机终端）。
* **拉起服务：** 输入 \`systemctl restart sshd\`（Debian/Ubuntu 适用 \`systemctl restart ssh\`）。
* **放行端口警告：** 若曾自行修改过 SSH 端口，必须执行 \`ufw allow 新端口/tcp\` 或相应的 firewalld 命令。未放行便重启服务，会立刻导致服务器失联。

## 三、确诊是 IP 被封？直接看 CN2 GIA-E

在排除所有基础错误、甚至尝试更换新端口后，若 \`tcp.ping.pe\` 依然显示国内全红——说明遇到了真正的线路与 IP 死局。

此时，不建议去后台支付 8.79 美元盲目更换新 IP。单次购买的普通线路 IP 晚高峰依然存在拥堵，且随时面临二次封锁的风险。

对于长期运营的正式中文站，**直接采用 CN2 GIA-E 方案是更具容错率的决策。**

| 核心破局方案 | 适用场景 | 破除封锁的核心机制 | 直达入口 |
| :--- | :--- | :--- | :--- |
| **CN2 GIA-E 20G** | 单个中文站、轻量 WordPress | **支持 10+ 高端机房自由切换。** 若遇 IP 封锁，后台一键 Migrate，三分钟即可分配新机房与全新 IP，彻底规避单点封锁风险。 | [查看 20G 套餐](https://bwh81.net/aff.php?aff=80471&pid=87) |
| **CN2 GIA-E 40G** | 长期大中型站点、图片/插件繁多 | 硬盘空间翻倍，后期无需频繁扩容。同等享受无限次免费机房迁移特权。 | [查看 40G 套餐](https://bwh81.net/aff.php?aff=80471&pid=88) |

**关于优惠码与测速的实战声明：**
放弃寻找隐藏神券的无用功。目前搬瓦工官方未放出任何可用的全场优惠码，结算页的显示即为最终价格。本站表格提供的核心机房测速与测试 IP，均为实机验证的最新准确数据。请依据项目的实际预算直接决策，将核心精力回归到站点本身的搭建上。

## 四、常见问题 FAQ

**修改 SSH 端口后，还要放行防火墙吗？**
必须放行。操作逻辑需严格遵守：先在防火墙放行新端口 -> 修改 sshd 配置文件 -> 重启 sshd 测试新端口登录。确认连接成功后，再关闭旧端口。

**新买的搬瓦工连不上，可以退款吗？**
符合 30 天新用户政策的订单支持全额退款。提交工单时需直击痛点，直接附上 KiwiVM 的 Running 截图、SSH 报错截图以及 \`tcp.ping.pe\` 的全红测试图。执行退款操作前，务必确认机器内部无重要数据残留。
`
  }
];
